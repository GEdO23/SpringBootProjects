...
public class Time {
	...
	@Size(min = 5, max = 255, message = "Não é possível cadastrar um time com menos de 3 letras ou mais de 255 letras")
	private String nome;
	
	@Enumerated(EnumType.STRING)
	private ListaUF uf;
	
	@NotEmpty(message = "Não é possível cadastrar um time sem hino")
	private String hino;
	
	@NotEmpty(message = "Não é possível cadastrar um time sem brasão")
